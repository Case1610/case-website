...
- **About**: 確かめられるプロフィール情報（職歴、学歴、資格、スキル）
- **Works**: 作ったものの一覧（作った順）。その場で触れるものもここに含む
- **Contact**: 連絡先情報とソーシャルリンク

### 🛠️ その場で触れるもの（Works に統合済み）
- Markdownサンドボックス（`/works/markdown-sandbox`）
- ソーシャルスタイル診断（`/works/social-style-test`）
